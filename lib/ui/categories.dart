...
import 'package:wakala/ui/wakala.dart';
  ...
  Future<List<dynamic>> fetchCategories() async {
    try {
      var response = await http
          .get("http://w.almustaqbal.ly//wp-json/wp/v2/categories?per_page=100");
      ...
      builder: (context, categorySnapshot) {
        if (categorySnapshot.hasData) {
          ...
          return ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: categorySnapshot.data.length-3,
